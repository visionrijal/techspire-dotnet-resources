...
![Opening PowerShell as Administrator](./images/powershell.png)
...
![Execution policy confirmation prompt](./images/execution-policy.png)
...
![winget installing the .NET SDK](./images/winget.png)
...
![VS Code with C# Dev Kit installed](./images/image.png)
